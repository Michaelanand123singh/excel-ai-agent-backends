...
from app.api.v1.endpoints.query_all_files import router as query_all_files_router
...
api_router_v1.include_router(query_all_files_router, prefix="/query-all-files", tags=["query-all-files"])
